...
class EquipmentStore extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'elementalResistance.max' => 'The elemental resistance must be a string',
    ...
    public function codes(): array
    {
        return [
            ...
            'elementalResistance.string' => 'EQU-0202-0011',
            'elementalResistance.max' => 'EQU-0202-0012',
            'elementalResistanceValue.integer' => 'EQU-0202-0013',
            'elementalResistanceValue.min' => 'EQU-0202-0014',
            'elementalResistanceValue.max' => 'EQU-0202-001',
            'class.required' => 'EQU-0202-0016',
            'class.string' => 'EQU-0202-0017',
            'class.max' => 'EQU-0202-0018',
        ];
    }
